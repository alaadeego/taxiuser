//
//  DriverRegisFormViewController.swift
//  Mashy
//
...
class DriverRegisFormViewController: UIViewController , UIImagePickerControllerDelegate,
UINavigationControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        AppDelegate.currentDriver.regForm = imageStr
    ...
    @IBAction func nextButtonAction(_ sender: Any) {
        if AppDelegate.currentDriver.regForm != ""{
            performSegue(withIdentifier: "periodic_ins", sender: self)
        }
    }
    /*
    // MARK: - Navigation
