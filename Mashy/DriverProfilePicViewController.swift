//
//  DriverProfilePicViewController.swift
//  Mashy
//
...
class DriverProfilePicViewController: UIViewController , UIImagePickerControllerDelegate,
UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        AppDelegate.currentDriver.profilePic = imageStr
    ...
    @IBAction func nextButtonAction(_ sender: Any) {
        if AppDelegate.currentDriver.profilePic != ""{
