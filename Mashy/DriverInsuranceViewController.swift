//
//  DriverInsuranceViewController.swift
//  Mashy
//
...
class DriverInsuranceViewController: UIViewController , UIImagePickerControllerDelegate,
UINavigationControllerDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        AppDelegate.currentDriver.insurance = imageStr
    ...
    @IBAction func nextButtonAction(_ sender: Any) {
        if AppDelegate.currentDriver.insurance != ""{
