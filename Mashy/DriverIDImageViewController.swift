//
//  DriverIDImageViewController.swift
//  Mashy
//
...
class DriverIDImageViewController: UIViewController , UIImagePickerControllerDelegate,
UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        AppDelegate.currentDriver.IDImage = imageStr
    ...
    @IBAction func nextButtonAction(_ sender: Any) {
        if AppDelegate.currentDriver.IDImage != ""{
            performSegue(withIdentifier: "profile_pic", sender: self)
        }
    }
